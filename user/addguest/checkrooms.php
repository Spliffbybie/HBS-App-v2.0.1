...
<td class="logout_box"><img src = "../../lib/images/online_u.png" align="bottom"> <?php echo $_SESSION['MM_Username']; ?> | <a href="<?php echo $logoutAction ?>" class="linkAsButton"><span>Log out</span></a></td>
